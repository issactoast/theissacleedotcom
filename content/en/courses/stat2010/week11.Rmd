...
$$
\sqrt{\frac{p_{1}\left(1-p_{1}\right)}{n_{1}}+\frac{p_{1}\left(1-p_{2}\right)}{n_{2}}}
$$
...
### Hands-on example - The usage of Instagram
...
Q1. What is the expected number for each cell?

Q2. Can we apply Chi-square test to this data?

Q3. We want to test whether the two variables(School year and Instagram usage) affects to each other. What is the Chi-square test statistic?

Q4. If we use $\alpha = 0.05$, what is the decision?
